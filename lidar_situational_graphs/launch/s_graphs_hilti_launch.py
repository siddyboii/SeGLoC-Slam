...
═══════════════════════════════════════════════════════════════════
  ...
  Usage:
    ros2 launch lidar_situational_graphs s_graphs_hilti_launch.py
    # Then in another terminal:
    ros2 bag play hilti14_ros2/ --clock
═══════════════════════════════════════════════════════════════════
"""
...
def generate_launch_description():
    ...
    imu_tf = Node(
        ...
        arguments=[
            ...
            "--yaw", "0.0",
            "--frame-id", "base_link",
            "--child-frame-id", "imu_sensor_frame",
        ],
        parameters=[{"use_sim_time": True}],
    )
